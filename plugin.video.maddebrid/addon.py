...
def index():
    downloads = {
        'label': 'My downloads',
        'path': 'plugin://plugin.video.maddebrid/downloads/',
        'is_playable': False,
    }
    torrents = {
        'label': 'My torrents',
        'path': 'plugin://plugin.video.maddebrid/torrents/',
        'is_playable': False,
    }
    account = {
        'label': 'Account',
        'path': 'plugin://plugin.video.maddebrid/account/',
        'is_playable': False,
    }
    ad = {
        'label': 'WTYCZKA POBRANA Z WWW.KODIWPIGULCE.PL',
        'path': 'plugin://plugin.video.maddebrid/',
        'is_playable': False,
    }
...
def downloads():
    ...
    for download in download_list:
        ...
        delete_link = (
            'plugin://plugin.video.maddebrid/downloads/{0}/delete/'
        ).format(download['id'])
...
def torrents():
    ...
    for torrent in torrent_list:
        ...
        torrent_link = (
                'plugin://plugin.video.maddebrid/torrents/{0}/'
            ).format(torrent['id'])
        info_link = (
                'plugin://plugin.video.maddebrid/torrents/{0}/info/'
            ).format(torrent['id'])
        ...
        if torrent['status'] == 'downloaded':
            unrestrict_link = (
                'plugin://plugin.video.maddebrid/torrents/{0}/unrestrict/'
            ).format(torrent['id'])
        ...
        delete_link = (
            'plugin://plugin.video.maddebrid/torrents/{0}/delete/'
        ).format(torrent['id'])
        torrent_context_menu.append(
            ('Delete', make_run(delete_link))
        )
