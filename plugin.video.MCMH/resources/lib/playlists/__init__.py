...
# -*- coding: utf-8 -*-
"""
:module: madhouseconnect.playlists
...
# Which playlist formates are supported by MHC?
SUPPORTED_FILETYPES = (
    'm3u',
    # 'm3u8'
    # 'pls',
...
def sync_plex_playlist(playlist=None, xml=None, plex_id=None):
    ...
    * Plex music playlists return False if MHC audio sync is disabled
    * Whether filename matches user settings to sync, if enabled
...
class PlaylistEventhandler(events.FileSystemEventHandler):
    """
    MHC eventhandler to monitor Kodi playlists safed to disk
    """
