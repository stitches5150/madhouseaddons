...
WINDOW_UPSTREAM = 'madhouseconnect.result.upstream'.encode('utf-8')
WINDOW_DOWNSTREAM = 'madhouseconnect.result.downstream'.encode('utf-8')
WINDOW_COMMAND = 'madhouseconnect.command'.encode('utf-8')
...
def send(pkc_listitem, target='default'):
    ...
    objects between different MHC python instances (e.g. if default.py is
