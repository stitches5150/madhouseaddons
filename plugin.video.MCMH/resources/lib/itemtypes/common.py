...
class ItemBase(object):
    ...
    """
    def __init__(self, last_sync, mchmdb=None, kodidb=None, lock=True):
        self.last_sync = last_sync
        self.lock = lock
        self.mchmdb = mchmdb
        self.kodidb = kodidb
        self.plexconn = mchmdb.plexconn if mchmdb else None
        self.plexcursor = mchmdb.cursor if mchmdb else None
