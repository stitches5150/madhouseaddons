...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem(32011, 'jsptmovieGenres', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32012, 'jsptmovieYears', 'js.png', 'DefaultMovies.png')
        #self.addDirectoryItem(32013, 'jsptmoviePersons', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32014, 'jsptmovieLanguages', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32015, 'jsptmovieCertificates', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32017, 'apmovies&url=trending', 'js.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(32018, 'apmovies&url=popular', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32019, 'apmovies&url=views', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32020, 'apmovies&url=boxoffice', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32021, 'apmovies&url=oscars', 'js.png', 'DefaultMovies.png')
        self.addDirectoryItem(32022, 'apmovies&url=theaters', 'js.png', 'DefaultRecentlyAddedMovies.png')
        #self.addDirectoryItem(32005, 'movieWidget', 'js.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem(32011, 'jspttvGenres', 'js.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32016, 'jspttvNetworks', 'js.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32014, 'jspttvLanguages', 'lpng', 'DefaultTVShows.png')
        self.addDirectoryItem(32015, 'jspttvCertificates', 'js.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32012, 'jspttvYears', 'js.png', 'js.png')
        self.addDirectoryItem(32017, 'aptvshows&url=trending', 'js.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem(32018, 'aptvshows&url=popular', 'js.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32023, 'aptvshows&url=rating', 'js.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32019, 'aptvshows&url=views', 'js.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32024, 'aptvshows&url=airing', 'js.png', 'DefaultTVShows.png')
        #self.addDirectoryItem(32025, 'aptvshows&url=active', 'js.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32026, 'aptvshows&url=premiere', 'js.png', 'DefaultTVShows.png')
