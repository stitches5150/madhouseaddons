...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('End Users LISTS ', 'usersliNavigator', 'movies.png', 'DefaultMovies.png')
    ...
    def usersli(self, lite=False):
        self.addDirectoryItem('ωσℓғgιяℓ', 'wolfnav', 'genres.png', 'DefaultMovies.png')
        self.endDirectory()	
		
    def userswf(self, lite=False):
        self.addDirectoryItem('☆Wolfs apocolypse☆', 'movies&url=wfa', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('☆Wolfs monster movies☆', 'movies&url=wfb', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('☆Wolfs laugh off  ☆', 'movies&url=wfc', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('☆Wolfs Howls  ☆', 'movies&url=wfd', 'movies.png', 'DefaultMovies.png')
        self.endDirectory()
