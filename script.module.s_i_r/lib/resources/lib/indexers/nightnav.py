...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem(32011, 'nightmaremovieGenres', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(32012, 'nightmaremovieYears', 'fre.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem(32011, 'nightmaretvGenres', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32016, 'nightmaretvNetworks', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32014, 'nightmaretvLanguages', 'lpng', 'DefaultTVShows.png')
        self.addDirectoryItem(32015, 'nightmaretvCertificates', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32012, 'nightmaretvYears', 'fre.png', 'fre.png')
        self.addDirectoryItem(32017, 'nmaretv&url=trending', 'fre.png', 'DefaultRecentlyAddedEpisodes.png')
