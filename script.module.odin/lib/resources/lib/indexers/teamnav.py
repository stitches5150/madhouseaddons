...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('Lockdowns Area', 'ldmovNavigator', 'lock.png', 'decepticons.png')
        self.addDirectoryItem('Enforcers Area', 'EnforcermoNavigator', 'ENFORCER.png', 'decepticons.png')
        self.addDirectoryItem('Warhammers Area', 'warhammermoNavigator', 'WAR.png', 'decepticons.png')
        self.addDirectoryItem('Katostrophics Area', 'katsmoNavigator', 'kat.png', 'decepticons.png')
        self.addDirectoryItem('Stalker Area', 'stalkermoNavigator', 'stalker.png', 'decepticons.png')
        self.addDirectoryItem('BoneCrushers Area.', 'BftvNavigator', 'icon.png', 'decepticons.png')
    ...
    def Bftv(self, lite=False):
        self.addDirectoryItem('bone crushers fav tv shows', 'tvshows2&url=tmdbBcfavs', 'icon.png', 'decepticons.png')
    ...
    def Enforcermo(self, lite=False):
        ...
        self.addDirectoryItem('Enforcer Tv Shows', 'tvshows2&url=tmdbenforcersfavs', 'ENFORCER.png', 'decepticons.png')
