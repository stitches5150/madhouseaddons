...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('Kids zone', 'KidsNavigator', 'Kids zone.png', 'DefaultMovies.png')
        self.addDirectoryItem('Toddler', 'toddlerNavigator', 'Kids zone.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('Teen', 'TeenNavigator', 'Kids zone.png', 'DefaultMovies.png')
        self.addDirectoryItem('Nature', 'NatureNavigator', 'Kids zone.png', 'DefaultMovies.png')
    ...
    def Kids(self, lite=False):
        ...
        self.addDirectoryItem('Kids T.V Shows', 'tvshows2&url=tmdbKids', 'Kids zone.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def Teen(self, lite=False):
        ...
        self.addDirectoryItem('Teen T.v Shows', 'tvshows2&url=tmdbteen', 'Kids zone.png', 'DefaultRecentlyAddedMovies.png')		
        self.endDirectory()
    ...
    def Nature(self, lite=False):
        ...
        self.addDirectoryItem('Nature  And Learning T.V Shows', 'tvshows2&url=tmdblearning', 'Kids zone.png', 'DefaultRecentlyAddedMovies.png')

        self.endDirectory()

    def toddler(self, lite=False):
        self.addDirectoryItem('Toddler tv shows', 'tvshows2&url=tmdbtoddler', 'Kids zone.png', 'decepticons.png')
