...
#        self.addDirectoryItem('', 'tvshows2&url=tmdbdarktv', 'decepticons.png', 'decepticons.png')
#        self.addDirectoryItem('', 'movies2&url=tmdbfirestick', 'decepticons.png', 'decepticons.png')
#        self.addDirectoryItem('', 'tvshows2&url=tmdbfirestick', 'decepticons.png', 'decepticons.png')
