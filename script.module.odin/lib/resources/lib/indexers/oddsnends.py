...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('Kung fu', 'KfulegNavigator', 'Kung fu.png', 'decepticons.png')
#       self.addDirectoryItem(32574, 'metalNavigator', 'Rock.png', 'decepticons.png')
        self.addDirectoryItem('legends', 'MlNavigator', 'legends.png', 'decepticons.png')
        self.addDirectoryItem('Sports', 'SwmNavigator', 'Sports.png', 'decepticons.png')
        self.addDirectoryItem('groups', 'darktvNavigator', 'groups.png', 'decepticons.png')
        self.addDirectoryItem('anime', 'amNavigator', 'anime.png', 'decepticons.png')
        self.addDirectoryItem('Users requests', 'usersNavigator', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('paranormal', 'ParamNavigator', 'paranormal.png', 'decepticons.png')
        self.addDirectoryItem('B rated', 'BrNavigator', 'B rated.png', 'decepticons.png')
        self.addDirectoryItem('Morbid', 'MhNavigator', 'Morbid.png', 'decepticons.png')
        self.addDirectoryItem('Kings of comedy', 'kocNavigator', 'comedy.png', 'decepticons.png')
        self.addDirectoryItem('Queens Of comedy', 'qocNavigator', 'comedy.png', 'decepticons.png')
