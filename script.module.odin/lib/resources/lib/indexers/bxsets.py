...
#        self.addDirectoryItem('War', 'warNavigator', 'decepticons.png', 'decepticons.png')
    ...
    def Clts(self, lite=False):
        ...
        self.addDirectoryItem('canada loves tv shows', 'tvshows2&url=tmdbClts', 'decepticons.png', 'decepticons.png')
    ...
    def Urt(self, lite=False):
        ...
        self.addDirectoryItem('Users requests tv ', 'tvshows2&url=tmdbUrt', 'decepticons.png', 'decepticons.png')
    ...
    def Tts(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('Toddler tv shows', 'tvshows2&url=tmdbTts', 'decepticons.png', 'decepticons.png')
    ...
    def Kzt(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('Kids zone tv', 'tvshows2&url=tmdbKzt', 'decepticons.png', 'decepticons.png')
    ...
    def Bftv(self, lite=False):
        self.addDirectoryItem('bone crushers fav tv shows', 'tvshows2&url=tmdbBft', 'decepticons.png', 'decepticons.png')
    ...
    def Docstv(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('documentary tv', 'tvshows2&url=tmdbDocstv', 'decepticons.png', 'decepticons.png')
    ...
    def at(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('anime tv', 'tvshows2&url=tmdbat', 'decepticons.png', 'decepticons.png')
    ...
    def Tl(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('Tv legends', 'tvshows2&url=tmdbTl', 'decepticons.png', 'decepticons.png')
    ...
    def Sfts(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('Sci fi tv shows', 'tvshows2tvshows2&url=tmdbSfts', 'decepticons.png', 'decepticons.png')
    ...
    def Paratv(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem(' paranormal tv', 'tvshows2&url=tmdbParamtv', 'decepticons.png', 'decepticons.png')
    ...
    def ldmov(self, lite=False):
        ...
        self.addDirectoryItem('LockDown Tv Shows', 'tvshows2&url=tmdbldtv', 'lock.png', 'decepticons.png')

        self.endDirectory()

    def Enforcermo(self, lite=False):
        self.addDirectoryItem('Enforcer movies', 'movies2&url=tmdbenmov', 'ENFORCER.png', 'decepticons.png')
        self.addDirectoryItem('Enforcer Tv Shows', 'tvshows2&url=tmdbentv', 'ENFORCER.png', 'decepticons.png')

        self.endDirectory()

    def warhammermo(self, lite=False):
        self.addDirectoryItem('Warhammer movies', 'movies2&url=tmdbwarm', 'WAR.png', 'decepticons.png')
        self.addDirectoryItem('Warhammer Tv Shows', 'tvshows2&url=tmdbwartv', 'WAR.png', 'decepticons.png')
    ...
    def katsmo(self, lite=False):
        ...
        self.addDirectoryItem('Kastastrophy Tv Shows', 'tvshows2&url=tmdbkatstv', 'kat.png', 'decepticons.png')
    ...
    def stalkermo(self, lite=False):
        ...
        self.addDirectoryItem('Stalkers Tv Shows', 'tvshows2&url=tmdbstalkertv', 'stalker.png', 'decepticons.png')
