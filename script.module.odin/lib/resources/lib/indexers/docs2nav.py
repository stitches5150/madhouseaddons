...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('natutre docs', 'natutredocsNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('the bible', 'thebibleNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('Conspiracies', 'ConspiraciesNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('mental', 'mentalNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('killers', 'killersNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('ufo', 'ufoNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('myths', 'mythsNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('bio', 'bioNavigator', 'documentary.png', 'DefaultMovies.png')
        self.addDirectoryItem('addiction', 'addictionNavigator', 'documentary.png', 'DefaultMovies.png')
    ...
    def natutredocs(self, lite=False):
        ...
        self.addDirectoryItem('natutre docs tv', 'tvshows2&url=tmdbnature', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def bible(self, lite=False):
        ...
        self.addDirectoryItem('the bible tv shows', 'tvshows2&url=tmdbbible', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def Conspiracies(self, lite=False):
        ...
        self.addDirectoryItem('Conspiracies tv shows', 'tvshows2&url=tmdbConspiracies', 'documentary.png', 'DefaultRecentlyAddedMovies.png')		
        self.endDirectory()
    ...
    def mental(self, lite=False):
        ...
        self.addDirectoryItem('Mental health tv shows', 'tvshows2&url=tmdbmental', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def killers(self, lite=False):
        ...
        self.addDirectoryItem('Killer tv shows', 'tvshows2&url=tmdbkillers', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def ufo(self, lite=False):
        ...
        self.addDirectoryItem('Ufo tv shows', 'tvshows2&url=tmdbufo', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Other Un Explained', 'movies2&url=tmdbother', 'documentary.png', 'decepticons.png')
        self.addDirectoryItem('Other Un Explained TV', 'tvshows2&url=tmdbother', 'documentary.png', 'decepticons.png')
        self.endDirectory()
    ...
    def myths(self, lite=False):
        ...
        self.addDirectoryItem('Myths tv shows', 'tvshows2&url=tmdbmyths', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('urban legends', 'movies2&url=tmdburban', 'documentary.png', 'decepticons.png')
        self.addDirectoryItem('urban legends TV', 'tvshows2&url=tmdburban', 'documentary.png', 'decepticons.png')
    ...
    def addiction(self, lite=False):
        ...
        self.addDirectoryItem('addiction tv shows ', 'tvshows2&url=tmdbaddiction', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def bio(self, lite=False):
        ...
        self.addDirectoryItem('Biographies tv shows', 'tvshows2&url=tmdbdbiographies', 'documentary.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
