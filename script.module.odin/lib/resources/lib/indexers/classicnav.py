...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('Action', 'action2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Adventure', 'adventure2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Animation', 'animation2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Comedy', 'comedy2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Crime', 'crime2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Drama', 'drama2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Family', 'family2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Fantay', 'fantasy2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Horror', 'horror2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Mystery', 'mystery2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Romance', 'romance2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Sci Fi', 'scifi2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Thriller', 'thriller2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('War', 'war2Navigator', 'classics.png', 'DefaultMovies.png')
        self.addDirectoryItem('Western', 'western2Navigator', 'classics.png', 'DefaultMovies.png')
    ...
    def action(self, lite=False):
        ...
        self.addDirectoryItem('Classic action ', 'tvshows2&url=tmdbclaction', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def adventure(self, lite=False):
        ...
        self.addDirectoryItem('Classic adventure  ', 'tvshows2&url=tmdbcladven', 'classics.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def animation(self, lite=False):
        ...
        self.addDirectoryItem('Classic animation ', 'tvshows2&url=tmdbclanim', 'classics.png', 'DefaultRecentlyAddedMovies.png')		
    ...
    def comedy(self, lite=False):
        ...
        self.addDirectoryItem('Classic comedy ', 'tvshows2&url=tmdbclcom', 'classics.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def crime(self, lite=False):
        ...
        self.addDirectoryItem('Classic crime ', 'tvshows2&url=tmdbclcrime', 'classics.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def drama(self, lite=False):
        ...
        self.addDirectoryItem('Classic drama ', 'tvshows2&url=tmdbcldram', 'classics.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def family(self, lite=False):
        ...
        self.addDirectoryItem('Classic family ', 'tvshows2&url=tmdbclfam', 'classics.png', 'DefaultRecentlyAddedMovies.png')		
    ...
    def fantasy(self, lite=False):
        ...
        self.addDirectoryItem('Classic fantasy ', 'tvshows2&url=tmdbfancl', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def horror(self, lite=False):
        ...
        self.addDirectoryItem('Classic horror ', 'tvshows2&url=tmdbclhoro', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def mystery(self, lite=False):
        ...
        self.addDirectoryItem('Classic mystery ', 'tvshows2&url=tmdbclmys', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def romance(self, lite=False):
        ...
        self.addDirectoryItem('Classic romance ', 'tvshows2&url=tmdbclrom', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def scifi(self, lite=False):
        ...
        self.addDirectoryItem('Classic scifi ', 'tvshows2&url=tmdbclscifi', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def thriller(self, lite=False):
        ...
        self.addDirectoryItem('Classic thriller ', 'tvshows2&url=tmdbclthrill', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def war(self, lite=False):
        ...
        self.addDirectoryItem('Classic war', 'tvshows2&url=tmdbclwar', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
    ...
    def western(self, lite=False):
        ...
        self.addDirectoryItem('Classic western tv shows', 'tvshows2&url=tmdbwesterns2', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
   

		
    def tools(self):
        self.addDirectoryItem('[B]URL RESOLVER[/B]: Settings', 'lulzfamresolversettings', 'tools.png', 'DefaultAddonProgram.png')
