...
ini          =  xbmc.translatePath(os.path.join('special://home/addon_data/script.ivueguide/addons2.ini','smokinbarrel.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.smokinbarrel/resources/ivue','plugin.video.smokinbarrel.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.smokinbarrel'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("smoking barrel","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.smokinbarrel/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.smokinbarrel/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("smoking barrel","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("smoking barrel","Installing iVue TV Guide...",'', 'Please Wait')
