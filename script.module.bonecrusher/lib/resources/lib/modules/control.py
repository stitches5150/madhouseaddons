...
def metaFile():
    if condVisibility('System.HasAddon(script.bonecrusher.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.bonecrusher.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
