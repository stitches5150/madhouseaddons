...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'bonecrusher Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.bonecrusher')
    ...
    try:
        curVersion = control.addon('script.module.bonecrusher').getAddonInfo('version')
