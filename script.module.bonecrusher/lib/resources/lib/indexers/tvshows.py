...
#        `=}--{='     `=}--{='
#       .-^--r-^-.   .-^--r-^-.
# bonecrusher is futile @lock_down... 
...
class tvshows:
    def __init__(self):
        ...
        self.tvdb_key = 'REFFMjMxOEMzMjAwNERFMw=='
...
##################################################################random#############################################################
        self.genreaction_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=action&sort=moviemeter,asc&count=40&start=1'
        self.genreadventure_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=adventure&sort=moviemeter,asc&count=40&start=1'
        self.genreAnimation_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=animation&sort=moviemeter,asc&count=40&start=1'
        self.genreAnime_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=anime&sort=moviemeter,asc&count=40&start=1'
        self.genreBiography_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=biography&sort=moviemeter,asc&count=40&start=1'
        self.genreComedy_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=comedy&sort=moviemeter,asc&count=40&start=1'
        self.genreCrime_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=crime&sort=moviemeter,asc&count=40&start=1'
        self.genreDocumentary_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=documentary&sort=moviemeter,asc&count=40&start=1'
        self.genreDrama_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=drama&sort=moviemeter,asc&count=40&start=1'
        self.genreFamily_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=family&sort=moviemeter,asc&count=40&start=1'
        self.genreFantasy_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=fantasy&sort=moviemeter,asc&count=40&start=1'
        self.genreHistory_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=history&sort=moviemeter,asc&count=40&start=1'
        self.genreHorror_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=horror&sort=moviemeter,asc&count=40&start=1'
        self.genreMusic_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=music&sort=moviemeter,asc&count=40&start=1'
        self.genreMusical_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=musical&sort=moviemeter,asc&count=40&start=1'
        self.genreMystery_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=mystery&sort=moviemeter,asc&count=40&start=1'
        self.genreRomance_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=romance&sort=moviemeter,asc&count=40&start=1'
        self.genrescifi_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sci_fi&sort=moviemeter,asc&count=40&start=1'
        self.genreSport_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=sport&sort=moviemeter,asc&count=40&start=1'
        self.genreThriller_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=thriller&sort=moviemeter,asc&count=40&start=1'
        self.genreWar_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=war&sort=moviemeter,asc&count=40&start=1'
        self.genreWestern_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=western&sort=moviemeter,asc&count=40&start=1'
        self.genretalk_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=talk_show&sort=moviemeter,asc&count=40&start=1'
        self.genrereality_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=reality_tv&sort=moviemeter,asc&count=40&start=1'
        self.genrenews_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=news&sort=moviemeter,asc&count=40&start=1'
###################################################################################################################################################################################
