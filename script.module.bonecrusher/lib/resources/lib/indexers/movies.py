...
##################################################################### random ######################################################
        self.genreaction_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=action&sort=moviemeter,asc&count=40&start=1'
        self.genreadventure_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=adventure&sort=moviemeter,asc&count=40&start=1'
        self.genreanimation_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=animation&sort=moviemeter,asc&count=40&start=1'
        self.genreanime_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=anime&sort=moviemeter,asc&count=40&start=1'
        self.genrebiography_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=biography&sort=moviemeter,asc&count=40&start=1'
        self.genrecomedy_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=comedy&sort=moviemeter,asc&count=40&start=1'
        self.genrecrime_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=crime&sort=moviemeter,asc&count=40&start=1'
        self.genredocumentary_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=documentary&sort=moviemeter,asc&count=40&start=1'
        self.genredrama_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=drama&sort=moviemeter,asc&count=40&start=1'
        self.genrefamily_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=family&sort=moviemeter,asc&count=40&start=1'
        self.genrefantasy_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=fantasy&sort=moviemeter,asc&count=40&start=1'
        self.genrehistory_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=history&sort=moviemeter,asc&count=40&start=1'
        self.genrehorror_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=horror&sort=moviemeter,asc&count=40&start=1'
        self.genremusic_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=music&sort=moviemeter,asc&count=40&start=1'
        self.genremusical_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=musical&sort=moviemeter,asc&count=40&start=1'
        self.genremystery_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=mystery&sort=moviemeter,asc&count=40&start=1'
        self.genreromance_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=romance&sort=moviemeter,asc&count=40&start=1'
        self.genrescifi_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=sci_fi&sort=moviemeter,asc&count=40&start=1'
        self.genresport_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=sport&sort=moviemeter,asc&count=40&start=1'
        self.genrethriller_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=thriller&sort=moviemeter,asc&count=40&start=1'
        self.genrewar_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=war&sort=moviemeter,asc&count=40&start=1'
        self.genrewestern_link = 'http://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[90]&genres=western&sort=moviemeter,asc&count=40&start=1'
########################################################################################################################################
