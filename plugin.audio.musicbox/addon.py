...
def Digster_sections():
	digster_domain = ['http://digster-adria.com/','http://www.digster.dk/','http://digster.ee/','http://www.digster.fi/','http://digster.lv/','http://digster.lt/','http://digster.mx/','http://www.digster.nl/','http://www.digster.co.nz/','http://www.digster.no/','http://www.digster.pt/','http://www.digster.ro/','http://www.digster.es/', 'https://www.digster.fm/'][int(selfAddon.getSetting('digster_country'))]
